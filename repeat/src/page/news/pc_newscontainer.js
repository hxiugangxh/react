        ...
        <Row>
          ...
          <Col span={20}>
            <div class="leftContainer">
              <div class="carousel">
                <Carousel {...settings}>
                  <div><img src={require('../..//images/carousel_1.jpg')} alt="无"/></div>
                  <div><img src={require('../..//images/carousel_2.jpg')} alt="无"/></div>
                  <div><img src={require('../..//images/carousel_3.jpg')} alt="无"/></div>
                  <div><img src={require('../..//images/carousel_4.jpg')} alt="无"/></div>
                </Carousel>
              </div>
